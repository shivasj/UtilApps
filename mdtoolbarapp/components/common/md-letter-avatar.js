(function() {
    'use strict';
    angular.module('ngMdLetterAvatar', [])
        .constant('mdLetterAvatarDefaults', {
            length:     2,
            textColor:  '#ffffff',
            color:      'auto',
        ...
        .directive('mdLetterAvatar', ['mdLetterAvatarDefaults', function(defaults) {
            return {
                restrict: 'E',
                scope: {
                    palette: '=palette',
                ...
                link: function(scope, element, attrs) {
                    scope.$watch('data', function(newValue) {
                        ...
                        var image = angular.element('<img src="' + getInlineData(svg) + '" height="'+params.height+'" width="'+params.width+'" />');
